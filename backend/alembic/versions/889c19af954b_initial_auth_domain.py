...
Revision ID: 889c19af954b
Revises:
Create Date: 2026-07-16 10:09:03.831690

Creates the core auth domain tables: users and refresh_tokens.
"""
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("roles", sa.String(500), nullable=False, server_default=sa.text("'Customer'")),
